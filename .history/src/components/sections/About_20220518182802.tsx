...
const AboutSection = ({ bio, skilss }: props) => {
  ...
  const GetIcon = (icon: keyof typeof iconObjec) => {
    

   const id:keyof typeof iconObject = icon

   const Value = iconObject[id]
    return <Value />
  }
      ...
      <div className="about-inner">
        ...
        <StyledStack>
          ...
          <div className="charts-container">
            {skilss &&
              skilss.map((skill: { name?: keyof typeof iconObject }, index) => {
