    ...
    <StyleAboutSection id="about">
      ...
      <div className="about-inner">
        <StyledAboutText>
          ...
          <p>
            Well-organised, problem solver, independent employee with high
            attention to detail. my free time I like to watch football. A family
            person and father of wonderfull doughter,
          </p>
          <p>
            Interested in the entire frontend spectrum and working on projects
