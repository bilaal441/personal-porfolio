...
export const getStaticProps = async () => {
  ...
  `invalid json response body at https://accounts.google.com/ServiceLogin?passive=1209600&osid=1&continue=https://console.firebase.google.com/project/portofolio-430c7/database/portofolio-430c7-default-rtdb/data/&followup=https://console.firebase.google.com/project/portofolio-430c7/database/portofolio-430c7-default-rtdb/data/ reason: Unexpected token < in JSON at position 1`
  )
